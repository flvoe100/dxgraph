 ...
 */
public class AtbLoadingSchedulerTask implements Task {
    private static final Logger LOGGER = LogManager.getFormatterLogger(AtbLoadingSchedulerTask.class.getSimpleName());

    public static final String MS_ROOTS = "ATB";
    ...
    public int execute(TaskContext p_ctx) {
        if (p_ctx.getCtxData().getSlaveId() == 0) {
            ...
            chunkService.create(ds);
            chunkService.put(ds);
            nameserviceService.register(ds,"ATBRL");
        }
        return 0;
    }
